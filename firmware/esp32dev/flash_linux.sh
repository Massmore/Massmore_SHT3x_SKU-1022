#!/bin/bash
# ============================================================================
#  Massmore SHT3X (SKU-1022) - อัปโหลดเฟิร์มแวร์ Factory Test ลง ESP32
#  สำหรับ Linux : รันด้วย bash flash_linux.sh
#
...
BAUD=512000
MERGED="Massmore_SHT3x_FactoryTest_v1.0.0_esp32dev_merged.bin"

echo "=============================================="
echo " Massmore SHT3X Factory Test - Flash Tool"
echo "=============================================="
